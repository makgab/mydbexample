  ...
  public function display() {
    ...
    foreach ( $rows as $row ) {
      $table_rows[] = array (
        'catid' => $row['catid'],
        'catname' => $row['catname'],
        'Edit' => Link::fromTextAndUrl( t('Edit'), Url::fromUserInput('/mydbexample/category/edit/'.$row['catid']) ),
        'Delete' => Link::fromTextAndUrl( t('Delete'), Url::fromUserInput('/mydbexample/category/delete/'.$row['catid']) ),
      );
    }
